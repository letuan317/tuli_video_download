...
class PyShine_THREADS_APP(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.pushButton_3.clicked.connect(self.start_work_3)
        self.pushButton_4.clicked.connect(self.start_work_1)
        self.pushButton_5.clicked.connect(self.start_work_2)
        self.pushButton_6.clicked.connect(self.start_work_3)
...
class ThreadClass(QtCore.QThread):
    ...
    def __init__(self, parent=None, index=0):
        super(ThreadClass, self).__inti__(parent)
        self.index = index
